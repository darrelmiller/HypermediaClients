...
namespace ExpenseApprovalApp
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            _ClientState = new ClientState(_httpClient);
        }
        ...
        void _ClientState_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "UserMessage")
            {
                ShowMessage(_ClientState.UserMessage);
            }
            else if (e.PropertyName == "CurrentCollection")
            {
            ...
            else if (e.PropertyName == "CurrentImage")
            {
                
                rootFrame.Navigate(typeof(ImagePage), _ClientState);
