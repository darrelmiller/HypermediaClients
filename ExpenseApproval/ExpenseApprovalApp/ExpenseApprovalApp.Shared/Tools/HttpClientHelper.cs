...
namespace ExpenseApprovalApp.Tools
{
...

    {
        ...
        public static async Task ProcessRedirect(HttpResponseMessage response, ClientState clientState, Link contextLink)
        {
        ...
        public static bool ProcessClientError(HttpResponseMessage response, ClientState clientState, Link contextLink)
        {
        ...
        public static void ProcessServerErrors(HttpResponseMessage response, ClientState clientState)
        {
