...
namespace ExpenseApprovalApp
{
    ...
    public sealed partial class ListPage : Page
    {
        ...
        private ListPageViewModel defaultViewModel;
        private ClientState _clientState;

        /// <summary>
        /// This can be changed to a strongly typed view model.
        /// </summary>
        public ListPageViewModel DefaultViewModel
        {
        ...
        {
            _clientState = e.NavigationParameter as ClientState;
            _clientState.PropertyChanged += _clientState_PropertyChanged;
            this.defaultViewModel = new ListPageViewModel(_clientState);
